...
Route::get('/nuevasadquisiciones','bibGeneralController@nuevasAdquisiones');
Route::get('/manualesytutoriales','bibGeneralController@manuales');
Route::get('/regalmentos','bibGeneralController@reglamentos');
