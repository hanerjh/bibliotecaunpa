 ...
 label{ font-weight:bold; }
   ...
   <div class="col-md-8">
        <div class="main-card mb-3 card">
                <div class="card-body">
                <h3 class="card-title">Registro publicaciones</h3>
                    <p class="">
                        En este formulario puede resgistrar anuncios, banner e imagenes para las ventanas emergentes<br> 
                     </p>
                     <form  action="/regpublicaciones" method="POST"  enctype="multipart/form-data" class="needs-validation">                 
                        @csrf
                           ...
                           @endif
                            ...
                            <div class="form-group">
                                    <label for="example-datetime-local-input" >Fecha y hora de cierre</label>
                                      <input name="fecha_cierre" class="form-control" type="datetime-local"  id="example-datetime-local-input">
